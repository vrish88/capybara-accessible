 ...
 *
 * Generated from http://github.com/GoogleChrome/accessibility-developer-tools/tree/8e35d64890a5f1222b054ed86ad74f419b2769a8
 *
...
axs.Audit.run = function(a) {
  ...
  for(e = 0;e < d.length;e++) {
    ...
    if(g && !g.disabled && (b || !g.requiresConsoleAPI)) {
      ...
      (0 < k.length || a.scope) && h.push(k);
      a.scope && h.push(a.scope);
      h = g.run.apply(g, h);
